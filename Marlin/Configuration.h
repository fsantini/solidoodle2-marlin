...
//#define AXIS_STEPS_NEGATIVE           {88,88,2000,108.3} // Step values to be used when travelling in the negative direction. Useful for threadless ball screws. Comment out if not needed
